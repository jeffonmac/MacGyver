...
class _SetuptoolsVersionMixin(object):
    ...
    def __iter__(self):
        ...
        warnings.warn(
            ...
            "inconsistent with the new version class_mod introduced in setuptools "
...
def register_loader_type(loader_type, provider_factory):
    ...
    `loader_type` is the type or class_mod of a PEP 302 ``module.__loader__``,
...
class Environment(object):
    ...
    def obtain(self, requirement, installer=None):
        ...
        base ``Environment`` class_mod, this routine just returns
...
class ContextualZipFile(zipfile.ZipFile):
    """
    Supplement ZipFile class_mod to support context manager for Python 2.6
    """
...
def register_finder(importer_type, distribution_finder):
    ...
    `importer_type` is the type or class_mod of a PEP 302 "Importer" (sys.path item
...
def _get_mro(cls):
    """Get an mro for a type or classic class_mod"""
