...
class LinuxDistribution(object):
    ...
    This package creates a private module-global instance of this class_mod with
    ...
    Normally, it is not necessary to create additional instances of this class_mod.
    However, in situations where control is needed over the exact data sources
    that are used, instances of this class_mod can be created with a specific
    ...
    def __init__(self,
                 ...
                 distro_release_file=''):
        """
        The initialization method of this class_mod gathers information from the
