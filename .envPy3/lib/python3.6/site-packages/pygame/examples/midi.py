...
def key_class(updates, image_strip, image_rects, is_white_key=True):
    """Return a keyboard key widget class_mod
    ...
    image_rects - A list of Rects giving the regions within image_strip that
        are relevant to this key class_mod.
    is_white_key (default True) - Set false if this is a black key.

    This function automates the creation of a key widget class_mod for the
    ...
    # Naming convention: Variables used by the Key class_mod as part of a
    ...
    # Some values used in the class_mod.
    #
