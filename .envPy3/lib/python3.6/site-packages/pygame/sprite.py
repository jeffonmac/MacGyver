...
are the main Sprite class_mod and several Group classes that contain Sprites.
...
The Sprite class_mod is intended to be used as a base class_mod for the different
types of objects in the game. There is also a base Group class_mod that simply
...
The basic Sprite class_mod can draw the Sprites it contains to a Surface. The
...
attributes or bools to a derived Sprite class_mod, consider keeping the
...
that you extend those when you create a new Sprite or Group class_mod.
...
## sort of like the GroupSingle class_mod, but holding more
## than one sprite
##
...
class Sprite(object):
    """simple base class_mod for visible game objects

    pygame.sprite.Sprite(*groups): return Sprite

    The base class_mod for visible game objects. Derived classes will want to
    override the Sprite.update() method and assign Sprite.image and Sprite.rect
    attributes.  The initializer can accept any number of Group instances that
    the Sprite will become a member of.

    When subclassing the Sprite class_mod, be sure to call the base initializer
    ...
    def update(self, *args):
        ...
        method by the same name in the Group class_mod.
...
class AbstractGroup(object):
    """base class_mod for containers of sprites

    AbstractGroup does everything needed to behave as a normal group. You can
    easily subclass a new group class_mod from this or the other groups below if
    ...
    def copy(self):
        ...
        Returns a copy of the group that is an instance of the same class_mod
        ...
        for sprite in sprites:
            ...
            if isinstance(sprite, Sprite):
                ...
                try:
                    ...
                    # instance of the Sprite class_mod or is not an instance of a
                    # subclass of the Sprite class_mod. Alternately, it could be an
    ...
    def remove(self, *sprites):
        ...
        # tries to handle each argument as an instance of the Sprite class_mod. If
...
class Group(AbstractGroup):
    """container class_mod for many Sprites

    pygame.sprite.Group(*sprites): return Group

    A simple container for Sprite objects. This class_mod can be subclassed to
...
class RenderUpdates(Group):
    """Group class_mod that tracks dirty updates

    pygame.sprite.RenderUpdates(*sprites): return RenderUpdates

    This class_mod is derived from pygame.sprite.Group(). It has an enhanced draw
...
class OrderedUpdates(RenderUpdates):
    """RenderUpdates class_mod that draws Sprites in order of addition

    pygame.sprite.OrderedUpdates(*spites): return OrderedUpdates

    This class_mod derives from pygame.sprite.RenderUpdates().  It maintains
...
class GroupSingle(AbstractGroup):
    ...
    This class_mod works just like a regular group, but it only keeps a single
...
class collide_rect_ratio:
    """A callable class_mod that checks for collisions using scaled rects

    The class_mod checks for collisions between two sprites using a scaled version
...
class collide_circle_ratio(object):
    ...
    This callable class_mod checks for collisions between two sprites using a
